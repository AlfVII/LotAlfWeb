...
def get_existing_in_hundred():
    ...
    missing_data_indexes = hundred[(hundred[['origin', 'lot', 'year', 'coin', 'retailer_province', 'retailer_town', 'retailer_number']].isnull().any(axis=1)) & (hundred['status'] == 'Perfecto')].index.to_list()
